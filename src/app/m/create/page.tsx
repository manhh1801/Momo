            ...
            <div className="relative bg-white w-full h-fit p-4 rounded-lg space-y-6">
                ...
                <div>
                    ...
                    <div className="relative">
                        <p className="absolute text-sm left-0 w-8 inset-y-0 grid place-items-center text-zinc-400">m/</p>
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <Button isLoading={isPending} disabled={input.length === 0} onClick={() => createCommunity()}>Create</Button>
                </div>
            </div>
        </div>
    );
